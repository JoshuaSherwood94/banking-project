...
public class AddDepositEvent implements ActionListener{
public JTextField tt1, tt2, tt3, tt4, tt5;
public String accNum;
public int balance;
public boolean on = false;
	
	public AddDepositEvent(JTextField t1, JTextField t2, JTextField t3, JTextField t4) {
		tt1 = t1;
		tt2 = t2;
		tt3 = t3;
		tt4 = t4;
	...
	public AddDepositEvent(JTextField t1, JTextField t2, JTextField t3, JTextField t4, JTextField t5) {
		tt1 = t1;
		tt2 = t2;
		tt3 = t3;
		tt4 = t4;
